...
function search_hn($conn)
{
    ...
    $query = "SELECT TOP 1 hncode.HnCode ,
...
function checkNSterileClaim($conn)
{
...
function updateClaimReturn($conn)
{
...
function checkClaimReturn($conn)
{
...
function show_detail_deproom_pay($conn)
{
    $return = array();
