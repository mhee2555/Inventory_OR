        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion " id="accordionSidebar" style="background-color: #004aad;overflow-y: auto;border: 2px solid #D0D5DD;">
            ...
            <div class="sb-sidenav-menu" id="mydiv" style="flex-grow:1;overflow-y: auto;max-height: 1000px;flex-grow:1;">
                ...
                <?php if ($RefDepID == "10106103") { ?>
                    ...
                    <li class="nav-item  py-2 collapse-inner rounded m-3 text-center" id="li_pay" >
                    ...
                    <li class="nav-item  py-2 collapse-inner rounded m-3 text-center" id="li_hn" >
                    ...
                    <li class="nav-item  py-2 collapse-inner rounded m-3 text-center" id="li_movement" >
                    ...
                    <li class="nav-item  py-2 collapse-inner rounded m-3 text-center" id="li_adjuststock" >
                    ...
                    <li class="nav-item  py-2 collapse-inner rounded m-3 text-center" id="li_register_item" >
                    ...
                    <li class="nav-item  py-2 collapse-inner rounded m-3 text-center" id="li_stock_item" >
                    ...
                    <li class="nav-item  py-2 collapse-inner rounded m-3 text-center" id="li_setting" >
