...
<div class="row mt-3">
    <div class=" col-md-12 col-lg-9  ">
        ...
        <div class="tab-button-group">
            <button class="tab-button active" id="radio_request">ขอเบิกอุปกรณ์</button>
            <button class="tab-button" id="radio_receive">รับอุปกรณ์เข้าคลัง</button>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="position-relative">
                            <input type="text" class="form-control rounded pr-5 f18" placeholder="" id="select_date1_rq" data-language='en' data-date-format='dd-mm-yyyy'>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="position-relative">
                            <input type="text" class="form-control rounded pr-5 f18" placeholder="" id="select_date2_rq" data-language='en' data-date-format='dd-mm-yyyy'>
                            <span class="input-icon">
                                <i class="fa-solid fa-calendar" style="color:black;"></i>
                            </span>
                        </div>
