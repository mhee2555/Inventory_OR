...
$sheet->setCellValue('C3', 'พิมพ์โดย ' . $_FirstName );
$sheet->setCellValue('C4', 'วันที่พิมพ์ ' . date('d/m/Y') . ' ' . date('H:i:s'));
...
$sheet->getStyle('A8:C' . ($rowIndex - 1))->applyFromArray($styleArray);

$sheet->getStyle('A8')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
$sheet->getStyle('B8:C' . ($rowIndex - 1))->applyFromArray($styleArray_Center);
