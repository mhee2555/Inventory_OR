...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->SetX(57);
        $this->Cell(50, 0,  "HN : " . $DepName, 0, 0, 'L');
        $this->SetX(110);
        $this->Cell(50, 0,  "Physician : - ", 0, 1, 'L');
        $this->SetX(57);
        ...
        $this->SetX(110);
        $this->Cell(25, 0,  "Room : - ", 0, 1, 'L');
        $this->SetX(57);
        $this->Cell(50, 0,  "Side Effect : - ", 0, 1, 'L');
        $this->SetX(57);
        $this->Cell(50, 0,  "หมายเหตุ : - ", 0, 1, 'L');
        ...
        QRcode::png($DepName, $file, $ecc, $pixel_size, $frame_size);
...
$count = 1;
    ...
    $Sql_Detail = "SELECT
                        ...
                        sell_department.departmentID AS HnCode,
                        department.DepName AS departmentroomname,
                        '1' AS Qty,
                    ...
                    FROM
                        sell_department
                    INNER JOIN department ON sell_department.departmentID = department.ID
                    LEFT JOIN sell_department_detail ON sell_department.DocNo = sell_department_detail.DocNo
                    ...
                    WHERE
                            sell_department.IsCancel = 0
                        AND sell_department.DocNo = '$DocNo'
                    ORDER BY
