    ...
    public function Header()
    {
        ...
        if ($this->page == 1) {
            ...
            $this->Ln(15);
              ...
              $this->Cell(0, 10,  "รายงานการเบิกอุปกรณ์ประจำวันตู้ RFID SmartCabinet", 0, 1, 'C');
...
<th width="35 %"  align="center">อุปกรณ์</th>
...
while ($Result_Detail = $meQuery1->fetch(PDO::FETCH_ASSOC)) {
    ...
    $html .=   '<td width="5 %" align="center"> ' .(int)$count . '</td>';
    $html .=   '<td width="20 %" align="center"> ' . $Result_Detail['itemcode2'] . '</td>';
    $html .=   '<td width="35 %" align="left">' . $Result_Detail['itemname'] . '</td>';
