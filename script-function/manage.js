...
$("#btn_saveDoctor").click(function () {
  if ($("#input_doctorth").val().trim() == "") {
    showDialogFailed("กรุณากรอกชื่อแพทย์");
    return;
  }

  // const pattern = /[~`!@#$%^&*()_\-+={}[\]|\\:;"'<>,.?/]/g;
  // if (pattern.test($("#input_doctorth").val().trim())) {
  //   showDialogFailed("ไม่อนุญาตให้ใช้อักขระพิเศษ");
  //   return;
  // }
