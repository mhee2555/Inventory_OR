  ...
  $("#btn_report").click(function (e) {
        if($("#select_report").val() == 1){
          ...
          if ($("#radio_month1").is(":checked")) {
            ...
            var option = "?type_date=" + $("#select_type_date").val()+"&date1=" + $("#select_date1").val()+"&date2=" + $("#select_date2").val()+"&month1=" + $("#select_month1").val()+"&month2=" + $("#select_month2").val()+"&checkday=" + checkday +"&checkmonth=" + checkmonth;
