...
function xxx(IDGroup) {
    ...
    var cnt = 0;
    if (table_data.$('.checkAllSubxx_' + IDGroup).val() == $("#input_scanexpire").val().trim()) {
...
function xxx2(IDGroup) {
    ...
    var cnt = 0;
    if (table_data.$('.checkAllSubxx_' + IDGroup).val() == $("#input_return_ex").val().trim()) {
